...
**예상 원인:**
- Vercel이 빌드 시 큰 바이너리 파일을 제외
- `node_modules/ffmpeg-static` 디렉토리가 배포에 포함되지 않음
- `node_modules/ffprobe-static` 디렉토리가 배포에 포함되지 않음
...
다음 정보를 확인할 수 있도록 로그 추가:
- 각 경로 존재 여부 확인
- `node_modules` 디렉토리 존재 여부
- `ffmpeg-static` / `ffprobe-static` 디렉토리 내용
- `bin/linux/x64/` 디렉토리 내용
...
```
[FFmpeg] 디버깅: node_modules ✅ 존재 / ❌ 없음 - /var/task/node_modules
[FFmpeg] 디버깅: ffmpeg-static 디렉토리 ✅ 존재 / ❌ 없음
[FFmpeg] 디버깅: ffmpeg-static 디렉토리 내용: [...]
[FFmpeg] 디버깅: bin 디렉토리 내용: [...]

[FFprobe] 디버깅: node_modules ✅ 존재 / ❌ 없음
[FFprobe] 디버깅: ffprobe-static 디렉토리 ✅ 존재 / ❌ 없음
[FFprobe] 디버깅: bin 디렉토리 내용: [...]
[FFprobe] 디버깅: linux 디렉토리 내용: [...]
[FFprobe] 디버깅: x64 디렉토리 내용: [...]
```
...
- ✅ 상세한 디버깅 로그 추가 완료
- ✅ 여러 루트 경로 시도 완료
- ⏳ 다음 배포 후 디버깅 로그 확인 필요

---

**다음 배포 후 디버깅 로그를 확인하여 바이너리 파일 존재 여부를 확인하세요!**
