# 널자 (Nullja) - 자영업자를 위한 AI 도구 모음집

**널리 자영업자를 이롭게 하라** (홍익AI)

7년 치킨집 사장이 운영하며 겪은 불편함들을 AI로 해결하고자 공부하며 만든 도구들을 공유하는 플랫폼입니다.

React(Next.js)와 Tailwind CSS로 구현된 자영업자 전용 AI 도구 및 커뮤니티 웹앱입니다.
